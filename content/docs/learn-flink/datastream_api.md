...
Flink's serializer [supports schema evolution for POJO types]({{< ref "/dev/stream/state/schema_evolution" >}}#pojo-types).
...
- [Anatomy of a Flink Program]({{< ref "/dev/datastream_api" >}}#anatomy-of-a-flink-program)
- [Data Sources]({{< ref "/dev/datastream_api" >}}#data-sources)
- [Data Sinks]({{< ref "/dev/datastream_api" >}}#data-sinks)
- [DataStream Connectors]({{< ref "/dev/connectors/index" >}})
