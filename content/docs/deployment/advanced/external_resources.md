...
[Flink Plugins]({{< ref "/deployment/filesystems/plugins" >}}). Apache Flink provides a first-party [plugin for GPU resources](#plugin-for-gpu-resources). You can also
...
See [Flink Plugin]({{< ref "/deployment/filesystems/plugins" >}}) for more details.
