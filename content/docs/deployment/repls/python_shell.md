...
See the [standalone resource provider page]({{< ref "/deployment/resource-providers/standalone/index" >}}) for more information about how to setup a local Flink.
You can also [build a local setup from source]({{< ref "/flinkDev/building" >}}).

<span class="label label-info">Note</span> The Python Shell will run the command “python”. Please refer to the Python Table API [installation guide]({{< ref "/dev/python/installation" >}}) on how to set up the Python execution environments.
