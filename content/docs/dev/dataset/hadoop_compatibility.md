...
- use Hadoop's `Writable` [data types]({{< ref "/dev/types_serialization" >}}#supported-data-types) in Flink programs.
...
[Connecting to other systems]({{< ref "/deployment/filesystems/index" >}}#hadoop-file-system-hdfs-and-its-other-implementations) guide for reading from Hadoop supported file systems.
