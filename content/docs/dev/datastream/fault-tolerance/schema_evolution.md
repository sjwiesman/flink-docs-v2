...
generated by Flink's own [type serialization framework]({{< ref "/dev/types_serialization" >}}).
...
(current scope of support is listed [below]({{< ref "/dev/stream/state/schema_evolution" >}}#supported-data-types-for-schema-evolution)).
...
[Custom State Serialization]({{< ref "/dev/stream/state/custom_serialization" >}}).
...
[here]({{< ref "/dev/stream/state/custom_serialization" >}}).
...
Flink supports evolving schema of [POJO types]({{< ref "/dev/types_serialization" >}}#rules-for-pojo-types), 
