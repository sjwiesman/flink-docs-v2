...
The Python SDK is supported as a [remote module](/sdk/#remote-module).
...
Messages's are untyped and passed through the system as protobuf {{< protoany >}} so one function can potentially process multiple types of messages.
...
A full reference of all methods supported by the context object are listed at the [bottom of this page](/sdk/python.html#context-reference).
...
State values could be absent, ``None``, or an {{< protoany >}}.

**Attention** [Remote modules](/sdk/#remote-module) require that all state values are eagerly registered at module.yaml.
