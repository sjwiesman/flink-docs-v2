...
你需要为使用的扩展资源准备插件，并将其放入 Flink 发行版的 `plugins/` 文件夹中, 参看 [Flink Plugins]({{< ref "/deployment/filesystems/plugins.zh" >}})。
...
更多细节请查看 [Flink Plugin]({{< ref "/deployment/filesystems/plugins.zh" >}})。
